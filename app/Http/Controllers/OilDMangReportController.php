...
class OilDMangReportController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('financial-administrative-directorate.oil-descharge.report', compact('reports'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('financial-administrative-directorate.oil-descharge.update-report', compact('report'));
    }
