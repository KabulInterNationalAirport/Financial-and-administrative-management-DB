...
class OfficersMangReportController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('financial-administrative-directorate.officers-mang.report' , compact('reports'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $reprot->save();
        return redirect('officer-report');
    }
    ...
    public function edit($id)
    {
        ...
        return view('financial-administrative-directorate.officers-mang.update-report', compact('report'));
    }
