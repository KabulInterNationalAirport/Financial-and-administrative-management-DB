...
class SaveCareMangReportController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('financial-administrative-directorate.save-and-care.report', compact('reports'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $reprot->save();
        return redirect('save-care-report');
    }
    ...
    public function edit($id)
    {
        ...
        return view('financial-administrative-directorate.save-and-care.update-report', compact('report'));
    }
