...
class PyrollReportController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('financial-administrative-directorate.payroll-management.report' , compact('reports'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('financial-administrative-directorate.payroll-management.update-report' ,compact('report'));
    }
