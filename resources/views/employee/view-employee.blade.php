                ...
                <div class="side-app main-container">
                    ...
                    <div class="page-header d-lg-flex d-block">
                        <div class="page-leftheader">
                            <div class="page-title">د کامند پروفایل</div>
                        </div>
                    </div>
                    <!-- END PAGE HEADER -->
                                    ...
                                    <div class="card-body">
                                        <div class="user-pic text-center">
                                            <span class="avatar avatar-xxl brround"
                                                style="background-image: url(assets/images/users/16.jpg)">
                                            ...
                                            <div class="pro-user mt-3">
                                                ...
                                                <h3>Kabul Internation Airport</h3>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="main-profile-body">
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="about">
                                                ...
                                                <div class="card-body d-block pt-3 ">
                                                ...
                                                <div class="card-body border-top">
                                                    ...
                                                    <a class="btn btn-sm btn-white mt-1"
                                                ...
                                                <div class="card-body border-top">
                                                    ...
                                                    <div class="main-profile-contact-list d-lg-flex">
                                                        <div class="media me-4">
                                                            <div
                                                                class="media-icon bg-primary-transparent text-primary me-3 mt-1">
                            ...
                            <div class="col-xl-7">
                                <div class="box-widget widget-user">
                                    <div class="widget-user-image d-sm-flex mb-4">
                                        <span class="avatar" style="background-image: url(assets/images/users/16.jpg)">
                                            <span class="avatar-status bg-green"></span>
                                        </span>
