            ...
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title" dir="rtl"><span
                            class="font-weight-normal text-muted ms-2">{{ __('depo/report.daily-report') }}</span>{{ __('depo/report.kabul-airport') }}
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-header">
                                <div class="d-xl-flex d-block">
                                    <form class="form-inline">
                                        ...
                                        <Button
                                            class="btn btn-light small ms-1">{{ __('layout-Financial.search') }}</Button>
                                    </form>
                                </div>
                            </div>
                            <div class="card-body">
                                                ...
                                                @foreach ($fin_adm_reports as $report)
                                                    @if ($report->state == 'تکمیل')
                                                        <tr>
                                                            ...
                                                            <td class="">
                                                                <a href="{{ url('main-report/' . $report->id) }}"
