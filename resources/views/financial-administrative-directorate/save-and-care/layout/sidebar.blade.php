                ...
                <div class="mt-4">
                    <div class="app-sidebar__user pb-2 mt-4">
                        <a class="dropdown  text-center" href="/">
                                <h2>{{__('layout-Financial.save-and-care')}}</h2>
                        </a>
                    </div>
                </div>
                <ul class="side-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="/save-care-employee">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="/save-care-report">
