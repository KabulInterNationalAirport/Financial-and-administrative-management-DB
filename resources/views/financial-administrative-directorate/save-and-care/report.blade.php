            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('save-care-report.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div>
                                ...
                                <select name="office" class="form-control custom-select select2">
                                    <option value="مدیریت حفظ مراقبت">{{__('layout-Financial.save-and-care')}}</option>
                                </select>
                            </div>
                            <div>
                                    ...
                                    <table class="table  table-vcenter text-nowrap table-bordered border-bottom"
                                        ...
                                        <tbody>
                                            @foreach ($reports as $report)
                                                @if ($report->related_office == 'مدیریت حفظ مراقبت')
                                                    @if ($report->state == 'نو')
                                                        <tr>
                                                            <td>{{ $report->id }}</td>
                                                            ...
                                                            <td class="">
                                                                <a href="{{ url('save-care-report/' . $report->id . '/edit') }}"
