        ...
        <div class="side-app main-container">
            ...
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title" dir="rtl"><span class="font-weight-normal text-muted ms-2">
                            {{ __('depo/report.daily-report') }}</span>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('logistic-report.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div>
                                        ...
                                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom"
                                            ...
                                            <tbody>
                                                @foreach ($reports as $report)
                                                    @if ($report->related_office == 'مدیریت تدارکات')
                                                        @if ($report->state == 'نو')
                                                            <tr>
                                                                <td>{{ $report->id }}</td>
                                                                ...
                                                                <td class="">
                                                                    <a href="{{ url('logistic-report/' . $report->id . '/edit') }}"
