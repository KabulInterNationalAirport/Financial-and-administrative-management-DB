        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <div class="page-title" dir="rtl"><span class="font-weight-normal text-muted ms-2">{{__('depo/report.daily-report')}}</span>
                    {{__('layout-Financial.oil-discharge')}}</div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('oil-d-report.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div>
                                ...
                                <select name="office" class="form-control custom-select select2">
                                    <option value="مدیریت تخلیه تیل">{{__('layout-Financial.oil-discharge')}}</option>
                                </select>
                            </div>
                            <div>
                                    ...
                                    <table class="table  table-vcenter text-nowrap table-bordered border-bottom"
                                        ...
                                        <tbody>
                                            @foreach ($reports as $report)
                                                @if ($report->related_office == 'مدیریت تخلیه تیل')
                                                    @if ($report->state == 'نو')
                                                        <tr>
                                                            <td>{{ $report->id }}</td>
                                                            ...
                                                            <td class="">
                                                                <a href="{{ url('oil-d-report/' . $report->id . '/edit') }}"
