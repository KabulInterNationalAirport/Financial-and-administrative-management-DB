     ...
     <div class="container">
         <div class="row align-items-center flex-row-reverse">
             <div class="col-md-12 col-sm-12 mt-3 mt-lg-0 text-center">
                 <a>.<span class="fa fa-heart text">Kabul International Airport</span>
                     Copyright © 2023 <a href="javascript:void(0);"></a>
             </div>
         </div>
     </div>
 </footer>
 ...
 <!-- INTERNAL ECHARTS JS -->
 <script src="{{asset('assets/plugins/echarts/echartsdirectorate.js')}}"></script>
 <script src="{{asset('assets/js/echartsdirectorate.js')}}"></script>
