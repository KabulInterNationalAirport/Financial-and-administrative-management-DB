                                ...
                                <div class="tabs-menu1">
                                    ...
                                    <ul class="nav panel-tabs">
                                        <li class="ms-4"><a href="#tab5" class="active" data-bs-toggle="tab">
                                                ...
                                                <li><a href="#tab6" data-bs-toggle="tab">{{ __('depo/employees.reg-it-product') }}</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="panel-body tabs-menu-body hremp-tabs1 p-0">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab5">
                                        ...
                                        <div class="card-body">
                                            <form action="{{route('delivered-product.store')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <input type="date" class="form-control" name="delivered_date" id="date"
                                                            placeholder="YYYY-_MM-DD">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="order-number"
                                                                class="col-form-label">{{ __('depo/delivered-products.offer-date') }}:</label>
                                                            <input type="date" name="offer_date" placeholder="YYYY-_MM-DD" class="form-control" id="order-number">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="number" class="form-control" id="serial-no">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="ram"
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="number" class="form-control" id="hd">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="unit"
                                                                class="col-form-label">{{ __('depo/delivered-products.unit') }}:</label>
