        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <div class="page-title" dir="rtl"><span class="font-weight-normal text-muted ms-2">{{__('depo/report.daily-report')}}</span>
                    {{__('layout-Financial.commodity-accounting-management')}}</div>
            </div>
                        ...
                        <form action="{{route('fin-adm-report.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <select name="office" class="form-control custom-select select2">
                                    <option value="مدیریت محاسبی جنسی">{{__('layout-Financial.commodity-accounting-management')}}</option>
                                </select>
                            </div>
                            <div>
                                    ...
                                    <table class="table  table-vcenter text-nowrap table-bordered border-bottom"
                                        ...
                                        <tbody>
                                            @foreach ($reports as $report)
                                                @if ($report->related_office == 'مدیریت محاسبی جنسی')
                                                    @if ($report->state == 'نو')
                                                        <tr>
                                                            <td>{{ $report->id }}</td>
                                                            ...
                                                            <td class="">
                                                                <a href="{{ url('commodity-report/' . $report->id . '/edit') }}"
