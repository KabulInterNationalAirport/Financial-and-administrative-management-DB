            ...
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title" dir="rtl"><span
                            class="font-weight-normal text-muted ms-2">{{ __('depo/report.daily-report') }}</span>
                                ...
                                <div>
                                    ...
                                    <select name="office" class="form-control custom-select select2">
                                        <option value="مالي او اداري آمریت">
                                            {{ __('layout-Financial.financial-and-administrative-management') }}</option>
                                    </select>
                                </div>
                                <div>
                                                ...
                                                @foreach ($reports as $report)
                                                    @if ($report->state == 'نو')
                                                        <tr>
                                                            ...
                                                            <td class="">
                                                                <a href="{{ url('fin-adm-report/' . $report->id . '/edit') }}"
