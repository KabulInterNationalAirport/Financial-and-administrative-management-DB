                            ...
                            <a href="javascript:void(0);">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="icon1 bg-danger my-auto  float-end"> <i
                            ...
                            <a href="javascript:void(0);">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="icon1 bg-primary float-end"> <i
                            ...
                            <a href="javascript:void(0);">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="icon1 bg-secondary   float-end"> <i
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="icon1 bg-success my-auto  float-end"> <i
                                                    class="feather feather-check"></i> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="btn-list">
                            <a href="javascript:void(0);"
                                class="btn btn-outline-light text-dark float-start me-4 d-flex  my-1"><span
                                    class="dot-label bg-light4 me-2 my-auto"></span>تېل</a>
                            <a href="javascript:void(0);"
                                class="btn btn-outline-light text-dark float-start me-4 d-flex  my-1"><span
                                    class="dot-label bg-primary me-2 my-auto"></span>راغلې پيسې</a>
