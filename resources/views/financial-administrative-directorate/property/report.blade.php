                            ...
                            <form>
                                <div>
                                    ...
                                    <select name="" class="form-control custom-select select2">
                                        <option value="{{__('layout-Financial.general-real-estate-management')}}">{{__('layout-Financial.general-real-estate-management')}}</option>
                                    </select>
                                </div>
                                <div>
                            ...
                            <div class="card-body">
                                <div class="mt-3">
                                    <div class="table-responsive">
                                        <table class="table  table-vcenter text-center table-bordered border-bottom" id="emp-attendance">
                                            <thead>
                                                <tr>
