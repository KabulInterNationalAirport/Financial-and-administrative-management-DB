                            ...
                            <form action="">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label ">{{__('financial/contract.contract-no')}}</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{__('financial/contract.contract')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label ">{{__('financial/contract.contract-reason')}}</label>
                                            <input type="text" class="form-control" placeholder="{{__('financial/contract.contract-reason')}}">
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{__('financial/contract.company')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="number" class="form-control" placeholder="{{__('financial/contract.executer-num')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
