                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('payroll-project-codes.store')}}" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    <div>
                                    ...
                                    <div>
                                        <label for="item-name" class="col-form-label">باب:</label>
                                        <select name="unit" class="form-control custom-select select2"
                                            data-placeholder="د باب نوع">
                                            <option label="د باب نوع"></option>
