                                ...
                                <div class="tabs-menu1">
                                    ...
                                    <ul class="nav panel-tabs">
                                        <li class="ms-4"><a href="#tab5" class="active"
                                                data-bs-toggle="tab">{{__('budget.budget-information')}}</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="panel-body tabs-menu-body hremp-tabs1 p-0">
                                <form action="{{route('payroll-budget.store')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <div class="card-body">
                                                <div class="card-header">
                                                    <h4 class="mb-4 font-weight-bold">
                                                        {{__('budget.budget-information')}}</h4>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <label
                                                                class="form-label mb-0 mt-2">{{__('budget.budget-type')}}</label>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <input name="type" type="text" class="form-control mb-md-0 mb-5"
                                                                placeholder="{{__('budget.budget-type')}}">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <label
                                                                class="form-label mb-0 mt-2">{{__('budget.budget-name')}}</label>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <input name="name" type="text" class="form-control"
                                                                placeholder="{{__('budget.budget-name')}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="date" name="date" class="form-control fc-datepicker"
