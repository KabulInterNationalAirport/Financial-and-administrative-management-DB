        ...
        <div class="side-app main-container">
            ...
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title" dir="rtl">{{__('budget.expense-budgets')}}</div>
                </div>
            </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="page-rightheader ms-md-auto">
                            <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                                <div class="btn-list">
                                    <a href="{{route('payroll-budget-expense.create')}}" class="btn btn-primary me-3">{{__('budget.add-budget')}}<i class="fa-solid fa-plus"></i></a>
                            ...
                            <table class="table  table-vcenter text-center table-bordered border-bottom" id="hr-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$budget->id}}</td>
                                        <td>
                                            {{$budget->received_type}}
                                        </td>
                                        <td>{{$budget->based_on}}</td>
                                        <td>{{$budget->number}}</td>
                                        <td>{{$budget->amount}}</td>
                                        <td>{{$budget->year}}</td>
                                        <td>{{$budget->month}}</td>
