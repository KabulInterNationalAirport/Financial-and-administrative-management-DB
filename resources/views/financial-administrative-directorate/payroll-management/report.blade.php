        ...
        <div class="side-app main-container">
            ...
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title" dir="rtl"><span class="font-weight-normal text-muted ms-2"> {{__('layout-Financial.daily-report')}}</span>
                        {{__('layout-Financial.payroll-management')}} </div>
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('payroll-report.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div>
                                    ...
                                    <select name="office" class="form-control custom-select select2"
                                        ...
                                        <option value="مدیریت معاشات">
                                            {{ __('layout-Financial.payroll-management') }}</option>
                                    </select>
                                </div>
                                <div>
                                        ...
                                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom"
                                            ...
                                            <tbody>
                                                @foreach ($reports as $report)
                                                    @if ($report->related_office == 'مدیریت معاشات')
                                                        @if ($report->state == 'نو')
                                                            <tr>
                                                                <td>{{ $report->id }}</td>
                                                                ...
                                                                <td class="">
                                                                    <a href="{{ url('payroll-report/' . $report->id . '/edit') }}"
