                            ...
                            <form action="">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label ">د قرار داد شهرت</label>
                                                <input type="text" class="form-control mb-md-0 mb-5"
                                                    placeholder="د قرار داد شهرت">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label ">میاشتنۍ کرایه </label>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="form-label ">د فعالیت ډول</label>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label class="form-label ">مساحت د مترمربع په اساس</label>
