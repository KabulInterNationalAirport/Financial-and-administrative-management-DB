								...
								<div class="main-proifle">
									<div class="card-body">
										<div class="invoice-header text-end d-block mb-5">
											<h1 class="invoice-title font-weight-semibold text-uppercase text-center mb-1">د کارمند د اجناسو لیست</h1>
										</div><!-- invoice-header -->
										<div class="row mt-4">
											<div class="col-md">
												<h4>د کارمند معلومات</h4>
                                                <h5>نوم:   Abdul Saboor hemat</h5>
                                                <h5>مبایل نمبر:  0790161600</h5>
                                                <h5>ایمیل ادرس:  saboorhemat@gmail.com</h5>
                                                <h5>مربوطه اداره:  آی ټي</h5>
                                                <h5>دنده:  د سیستم جوړولو عمومي مدیر</h5>
