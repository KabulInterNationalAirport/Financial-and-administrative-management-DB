            ...
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title" dir="rtl"><span class="font-weight-normal text-muted ms-2"></span>
                          د  خراپو اجناسو لیست</div>
                </div>
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h1 class="modal-title fs-5" id="exampleModalLabel">خراپ جنس اضافه کړۍ</h1>
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div >
                                  ...
                                  <div >
                                    <label for="f-s9-number" class="col-form-label">د تحویلي کس:</label>
                                    <input type="number" class="form-control" id="f-s9-number">
                                  </div>
                                  <div >
                                    <label for="order-number" class="col-form-label">مربوطه اداره:</label>
                                    <input type="number" class="form-control" id="order-number">
                                  </div>
                                  <div >
                                    <label for="administration" class="col-form-label">د معتمد نوم:</label>
                ...
                <div class="page-rightheader">
                    <button class="btn btn-primary" data-bs-target="#exampleModal" data-bs-toggle="modal">د خراپ جنس اضافه کول <i class="fa-solid fa-plus"></i></button>
                </div>
            </div>
            <div class="">
