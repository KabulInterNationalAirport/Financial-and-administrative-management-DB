                        ...
                        <div class="mt-0">
                            <form class="form-inline">
                                <div class="search-element">
                                    <input type="search" class="form-control header-search" placeholder="پلټنه..."
                                    ...
                                    <div class="d-flex ms-auto">
                                        ...
                                        <div class="dropdown ">
                                            <a class="nav-link icon" data-bs-toggle="dropdown">
                                                <img src="assets/images/files/lang icon.png" class="h-24"
                                                    alt="img">
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                                                <a href="javascript:void(0);" class="dropdown-item d-flex ">
                                                    <div class="d-flex"> <span class="my-auto">پښتو</span> </div>
                                                </a>
                                                <a href="javascript:void(0);" class="dropdown-item d-flex ">
                                                    <div class="d-flex"> <span class="my-auto">دری</span> </div>
                                                </a>
                                                <a href="javascript:void(0);" class="dropdown-item d-flex ">
                                                    <div class="d-flex"> <span class="my-auto">انګلسي</span> </div>
                                                </a>
                                            </div>
                                        </div>
                                        &nbsp;&nbsp;
